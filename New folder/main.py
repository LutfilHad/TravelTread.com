...
def draw_game_over_screen(win, score, high_score):
    win.fill((0, 0, 0))
    font = pygame.font.SysFont(None, 50)
    text = font.render("YOU ARE DEAD, YOU SUCK", True, (255, 0, 0))
    ...
    score_rect = score_text.get_rect(center=(550, 350))
    high_score_rect = high_score_text.get_rect(center=(550, 400))
    win.blit(score_text, score_rect)
    win.blit(high_score_text, high_score_rect)

    font = pygame.font.SysFont(None, 20)
    restart_text = font.render("Press R to restart or Q to quit the game", True, (255, 255, 255))
    restart_rect = restart_text.get_rect(center=(550, 450))
...
def main_game():
    ...
    while run:
        ...
        # Increment score based on game time
        score = game_time // 50  # Adjust the divisor to control the scoring speed
        ...
        if game_over:
            ...
            draw_game_over_screen(win, score, high_score)
            while True:
                for event in pygame.event.get():
                    if event.type == pygame.QUIT:
                        pygame.quit()
